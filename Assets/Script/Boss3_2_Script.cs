...
public class Boss3_2_Script : MonoBehaviour
{
    public float HP;
    public int MinusHP;
    public static Boss3_2_Script instance;
    private Boss3_1_Script b1;
    ...
    public void RandomAction()
    {
        ...
        {
            GetComponent<Animator>().Play("boss3_2_Atk1");
        }
        else if (randNum >= 50 && randNum <= 79)
        {
            GetComponent<Animator>().Play("boss3_2_Atk2");
        }
        else
        {
            GetComponent<Animator>().Play("boss3_2_idle");
        }
